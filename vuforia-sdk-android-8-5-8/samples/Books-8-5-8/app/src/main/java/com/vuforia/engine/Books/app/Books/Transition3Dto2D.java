...
class Transition3Dto2D
{
    ...
    private final float dpiScaleIndicator;
    ...
    Transition3Dto2D(int screenWidth, int screenHeight,
    ...
    void initializeGL(int sProgramID)
    {
    ...
    private void updateScreenProperties(int screenWidth, int screenHeight,
    ...
    void startTransition(float duration, boolean inReverse)
    {
    ...
    void render(float[] mProjectionMatrix, Matrix34F targetPose,
        int texture1)
    {
        ...
        Matrix.scaleM(modelViewMatrix, 0, 0.430f * scaleFactor,
            0.430f * scaleFactor, 1.0f);
        Matrix.multiplyMM(modelViewProjectionTracked, 0, mProjectionMatrix, 0,
            modelViewMatrix, 0);
        
        float elapsedTransformationCurrent = stepTransition();
    ...
    Matrix34F getFinalPositionMatrix34F()
    {
        ...
        for(int i = 0; i < 4; i ++)
        {
            System.arraycopy(glFinalPositionMatrix, i * 4, vuforiaFinalPositionMatrix, i * 3, 3);
        }
    ...
    private float[] getFinalPositionMatrix()
    {
        ...
        float scaleMultiplierHeight = scaleMultiplierWidth / aspectRatio;
